...
@skipUnless(not IBTEST_SERVER_PUBLIC_FILE, "These tests do not support OTW connection.")
class DatabaseAPI20Test(unittest.TestCase):
    ...
    def test_description(self):
        ...
        try:
            ...
            self.assertEqual(cur.description[0][1],self.driver.STRING.values[0],
    ...
    @skip("test_rowcount_on_select: InterBase does not return rowcount until fetch is called")
    def test_rowcount_on_select(self):
        con = self._connect()
        try:
            cur = con.cursor()
            cur.execute("select name from %sbooze" % self.table_prefix)
    ...
    def test_callproc(self):
        ...
        try:
            ...
            if self.lower_func and hasattr(cur,'callproc'):
                ...
                self.assertEqual(r[0][0].lower(),'foo',
    ...
    @skip("test_non_idempotent_close: the rowcount is reported as zero until at least one row has been fetched from the result set,")
